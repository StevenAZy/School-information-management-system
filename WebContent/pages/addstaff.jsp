                                ...
                                <form action="../AddstaffServlet" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                         ...
                                         <div class="col-md-2">
                                            <div class="form-group">
                                                <label>密码</label>
                                                <input name="pwd" type="text" class="form-control" placeholder="密码">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>职务</label>
                                                <input name="position" type="text" class="form-control" placeholder="职务" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>职称</label>
                                                <input name="title" type="text" class="form-control" placeholder="职称">
                                            </div>
                                        </div>
                                    </div>
									 ...
									 <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>部门</label>
                                                <input name="depart" type="text" class="form-control" placeholder="部门">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>邮件</label>
                                                <input name="email" type="email" class="form-control" placeholder="邮件">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>奖惩信息</label>
                                                <input name="reward" type="text" class="form-control" placeholder="奖惩信息" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>家庭关系</label>
                                                <textarea name="family" rows="5" class="form-control" ></textarea>
                                            </div>
                                        </div>
                                    </div>
