        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand">请填写员工信息</a>
                </div>
            </div>
        </nav>
                ...
                <div class="row">
                    <div class="col-md-16">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="/Shrims/ModifyServlet" method="post">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>单位 (不可改)</label>
                                                <input type="text" class="form-control" disabled placeholder="Company" value="常州大学">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>姓名</label>
                                                <input name="name" type="text" class="form-control" value="${modinfo[0].name}">
                                            </div>
                                        </div>
                                       <div class="col-md-3">
                                            <div class="form-group">
                                                <label>工号</label>
                                                <input name="id" type="text" class="form-control" value="${modinfo[0].id}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>职务</label>
                                                <input name="position" type="text" class="form-control" value="${modinfo[0].position}" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>职称</label>
                                                <input name="title" type="text" class="form-control" value="${modinfo[0].title}">
                                            </div>
                                        </div>
                                    </div>
									 ...
									 <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>部门</label>
                                                <input name="depart" type="text" class="form-control" value="${modinfo[0].depart}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>邮件</label>
                                                <input name="email" type="email" class="form-control" value="${modinfo[0].email}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>奖惩信息</label>
                                                <input name="reward" type="text" class="form-control" value="${modinfo[0].reward}" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>家庭关系</label>
                                                <input name="reward" type="text" class="form-control" value="${modinfo[0].family}" >
                                            </div>
                                        </div>
                                    </div>
