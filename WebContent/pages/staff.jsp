...
<div class="wrapper">
    <div class="sidebar" data-color="orange" data-image="/Shrims/picture/logo.png">
    	...
    	<div class="sidebar-wrapper">
            ...
            <div class="user">
                <div class="photo">
                    <img src="/Shrims/picture/default-avatar.png" />
                </div>
                <div class="info">
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>姓名</label>
                                                <input type="text" class="form-control" value="${staff[0].name }">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">工号</label>
                                                <input type="text" class="form-control" value="${staff[0].id }">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>职务</label>
                                                <input type="text" class="form-control" value="${staff[0].position }" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>职称</label>
                                                <input type="text" class="form-control" value="${staff[0].title }">
                                            </div>
                                        </div>
                                    </div>
									 ...
									 <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>部门</label>
                                                <input type="text" class="form-control" value="${staff[0].depart }">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>邮件</label>
                                                <input type="email" class="form-control" value="${staff[0].email }">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>奖惩信息</label>
                                                <input type="text" class="form-control" value="${staff[0].reward }" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>家庭关系</label>
                                                <input type="text" class="form-control" value="${staff[0].family }" >
                                            </div>
                                        </div>
                                    </div>
